<div>
    @if ($isOpen)
        <div class="flex flex-col w-full h-160 gap-4 bg-white shadow-2xl rounded-4xl absolute left-0 top-0 p-8">
            <button type="button" class="cursor-pointer w-full flex items-center justify-between" wire:click='closeModal'>
                ...
                <div class="w-full flex items-center gap-2 gameCategories overflow-x-auto pb-2">
                    ...
                    @foreach ($categories as $slug => $label)
                        <div wire:click="toggleCategory('{{ $slug }}')"
                            ...
                            <img src="{{ asset('images/game-icons/game-categories-icons/arts.png') }}" alt=""
                                class="h-6">
                                ...
                                <div class="flex items-center w-full justify-between">
                                    <div class="w-full flex items-center gap-2">
                                        ...
                                        <div class="flex flex-col">
                                            <h1 class="text-white font-medium text-sm truncate">{{ $activity->name }}
                                            </h1>
