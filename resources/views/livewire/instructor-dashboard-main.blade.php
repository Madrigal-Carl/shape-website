    ...
    <div class="mt-12 flex flex-col gap-4">
        ...
        <div class="grid grid-cols-4 grid-rows-1 gap-4">
            ...
            <div
                ...
                <h1 class="text-5xl font-bold">{{ $autismStudents }}</h1>
            </div>
            ...
            <div
                ...
                <h1 class="text-5xl font-bold">{{ $hearingStudents }}</h1>
            </div>
            ...
            <div
                ...
                <h1 class="text-5xl font-bold">{{ $speechStudents }}</h1>
            </div>
        </div>
        ...
        <div class="grid grid-cols-4 grid-rows-1 gap-4">
            <div class="bg-white p-6 h-48 text-heading-dark rounded-3xl flex flex-col justify-between gap-6">
                ...
                <h1 class="text-5xl font-bold text-blue-button">{{ $totalCurriculums }}</h1>
            </div>
            ...
            <div class="bg-white p-6 h-48 text-heading-dark rounded-3xl flex flex-col justify-between gap-6">
                ...
                <h1 class="text-5xl font-bold text-lime">{{ $totalLessons }}</h1>
            </div>
            ...
            <div class="bg-white p-6 h-48 text-heading-dark rounded-3xl flex flex-col justify-between gap-6">
                ...
                <h1 class="text-5xl font-bold text-yellowOrange">{{ $totalActivities }}</h1>
            </div>
            ...
            <div class="bg-white p-6 h-48 text-heading-dark rounded-3xl flex flex-col justify-between gap-6">
                ...
                <h1 class="text-5xl font-bold text-danger">{{ $totalAwards }}</h1>
            </div>
        </div>
    </div>
