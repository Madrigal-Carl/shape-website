<main class="col-span-7 pl-8 pr-10 py-4 flex flex-col h-dvh gap-16 overflow-y-none">
    ...
    <div class="flex flex-col gap-4 min-h-[20%]">
                    ...
                    <table class="table-auto border-separate relative">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-3 text-center text-paragraph">Activity name</td>
                                ...
                                <td class="px-4 py-3 text-center text-paragraph">
                                    <div class="flex justify-center items-center gap-1 text-white">
                                        <button wire:click='openEditActivityModal({{ 1 }})'
                                            ...
                                            <small class="transition-opacity duration-150"
                                                ...
                                                wire:target='openEditActivityModal({{ 1 }})'>
                                                Edit
                                            </small>
                                        ...
                                        <button wire:click='openViewActivityModal({{ 1 }})'
                                            ...
                                            <small class="transition-opacity duration-150"
                                                wire:loading.class="opacity-0"
                                                wire:target='openViewActivityModal({{ 1 }})'>
                                                View
                                            </small>

                                            <!-- Spinner (overlay) -->
                                            <svg wire:loading wire:target='openViewActivityModal({{ 1 }})'
                                                class="w-4 h-4 text-white animate-spin absolute" viewBox="0 0 100 101"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
        ...
        <div class="rounded-full bg-white gap-1 p-2 w-fit self-center-safe flex items-center text-sm shadow-2xl">
            ...
            <button class="py-1 px-4 hover:bg-blue-button rounded-full hover:text-white cursor-pointer">2</button>
