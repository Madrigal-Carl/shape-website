                ...
                <div class="w-180 h-full Addlesson bg-white p-8 rounded-4xl relative">
                    ...
                    <div class="Addlesson w-full h-[100%] flex flex-col gap-8 self-center-safe overflow-y-auto">
                        ...
                        <div class="flex flex-col gap-3">
                                    ...
                                    <div wire:key="activity-{{ $i }}"
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs">{{ collect($act->category ?? [])->map(fn($cat) => ucfirst(Str::of($cat)->explode(' ')->first()))->implode(', ') }}
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="flex flex-col w-full h-160 gap-4 bg-white shadow-2xl rounded-4xl absolute left-0 top-0 p-8">
                                ...
                                <div class="w-full flex flex-col gap-2">
                                    ...
                                    <div class="w-full flex items-center gap-2 gameCategories overflow-x-auto pb-2">
                                        <div class="w-fi shrink-0 flex items-center gap-2 bg-card px-3 py-1 rounded-xl text-paragraph hover:bg-blue-button hover:text-white cursor-pointer">
                                            <img src="{{ asset('images/game-icons/game-categories-icons/arts.png') }}" alt="" class="h-6">
                                            <p class="text-base">Math</p>
                                        </div>

                                        <div class="w-fit shrink-0 flex items-center gap-2 bg-card px-3 py-1 rounded-xl  text-paragraph hover:bg-blue-button hover:text-white cursor-pointer">
                                            <img src="{{ asset('images/game-icons/game-categories-icons/arts.png') }}" alt="" class="h-6">
                                ...
                                <div class="grid grid-cols-2 gap-2 overflow-y-auto rounded-xl gamesGrid">
                                    ...
                                    <div class="w-fit shrink-0 flex flex-col gap-2 relative cursor-pointer">
                                        ...
                                        <div class="absolute bottom-0 bg-gradient-to-t from-black/80 via-black/10 to-black/0 w-full h-full rounded-xl items-center">
                                            <div class="h-full w-full flex items-end justify-between p-3">
                                                <div class="flex items-center w-full justify-between" >
                                                    <div class="w-full flex items-center gap-2">
                                                        <img src="{{asset('images/game-icons/mario.jpeg')}}" alt="" class="h-10 rounded-lg aspect-square object-cover">
                                                        <div class="flex flex-col">
                                                            <h1 class="text-white font-medium text-sm truncate">Mario cart: World Tour</h1>
                                                            <p class="text-white/60 text-xs truncate font-light">Lorem ipsum dolor sit amet.</p>
                                                        </div>
                                                    </div>

                                                    <button type="button" class="cursor-pointer bg-white/40 backdrop-blur-sm px-3 py-1 rounded-full p-0 flex items-center justify-center text-white hover:bg-blue-button hover:scale-110">
